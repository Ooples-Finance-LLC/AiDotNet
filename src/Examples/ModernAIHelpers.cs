...
namespace AiDotNet.Examples
{
    ...
    public static class ModernAIHelpers
    {
        ...
        /// <summary>
        /// Creates an explainable model wrapper
        /// </summary>
        public static ExplainableModelWrapper<T> CreateExplainableModelWrapper<T>(
            IFullModel<T, Tensor<T>, Tensor<T>> baseModel)
            where T : struct, IComparable<T>, IConvertible, IEquatable<T>
        {
            return new ExplainableModelWrapper<T>(baseModel);
        }
