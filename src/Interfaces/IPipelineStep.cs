...
namespace AiDotNet.Interfaces
{
    ...
    public interface IPipelineStep<T>
    {
        ...
        Task FitAsync(Matrix<T> inputs, Vector<T>? targets = null);
        ...
        Task<Matrix<T>> TransformAsync(Matrix<T> inputs);
        ...
        /// <returns>Transformed data</returns>
        Task<Matrix<T>> FitTransformAsync(Matrix<T> inputs, Vector<T>? targets = null);
        ...
        bool ValidateInput(Matrix<T> inputs);
